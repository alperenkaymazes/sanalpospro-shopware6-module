...
<sw-page class="sanalpospro-webhook-log-list">
    ...
    `,mounted(){let e=106;try{const t=localStorage.getItem("paythor-merchant-app");t&&!isNaN(parseInt(t))&&(e=parseInt(t))}catch{}this._resolvedAppId=e,this.loadPayThorApp()},beforeDestroy(){this.cleanupPayThorApp()},methods:{async loadPayThorApp(){if(this.cleanupPayThorApp(),this._createdRoot=!document.getElementById("root"),this._createdRoot){const o=document.createElement("div");o.id="root",o.style.cssText="width: 100%; min-height: 800px; background: transparent;",this.$refs.reactContainer?this.$refs.reactContainer.appendChild(o):(o.style.cssText="position:fixed;top:130px;left:240px;right:0;bottom:0;z-index:10;background:#fff;overflow:auto;",document.body.appendChild(o))}try{const o=String(this._resolvedAppId||106),l="paythor-connect-app-id",r=["etc-token","etc-user-level","etc-is-impersonating","etc-original-admin-token","etc-impersonate-token"];localStorage.getItem(l)!==o&&(r.forEach(c=>localStorage.removeItem(c)),sessionStorage.clear(),localStorage.setItem(l,o))}catch(o){console.warn("SanalPosPro: LocalStorage access denied",o)}let e="shopware",t="/sanalpospro/iapi/index",a={order_status:"process",currency_convert:"no",showInstallmentsTabs:"no",paymentPageTheme:"modern"};try{const o=Shopware.Context.api.authToken&&Shopware.Context.api.authToken.access;if(o){const l=await fetch("/api/sanalpospro/admin-config",{headers:{Authorization:"Bearer "+o,Accept:"application/json"}});if(l.ok){const r=await l.json();e=r.xfvv||e,t=r.target_url||t,r.module_settings&&typeof r.module_settings=="object"&&(a=Object.assign(a,r.module_settings))}else console.error("SanalPosPro: Failed to fetch admin config",l.status)}else console.warn("SanalPosPro: no admin auth token available")}catch(o){console.error("SanalPosPro: Error fetching admin config",o)}const n=this._resolvedAppId||106,s=`https://cdn.paythor.com/1/${n}/10.0.4`;window.xfvv=e,window.target_url=window.location.origin+t,window.store_url=window.location.origin,window.app_id=n,window.platform="shopware",window.program_id=1,window.style_url=`${s}/index.css`,window.generalSettings={order_status:{default_value:a.order_status,options:{process:"Processing"}},currency_convert:{default_value:a.currency_convert,options:{yes:"Yes",no:"No"}},showInstallmentsTabs:{default_value:a.showInstallmentsTabs,options:{yes:"Yes",no:"No"}},paymentPageTheme:{default_value:a.paymentPageTheme,options:{classic:"Classic",modern:"Modern"}}};const i=document.createElement("link");i.id="paythor-style",i.rel="stylesheet",i.href=window.style_url,document.head.appendChild(i);const p=document.createElement("script");p.id="paythor-script",p.type="module",p.src=`${s}/index.js?v=`+Date.now(),p.onerror=()=>console.error("[SanalPosPro] CDN script failed to load:",p.src),document.body.appendChild(p)},cleanupPayThorApp(){const e=document.getElementById("paythor-script");e&&e.remove();const t=document.getElementById("paythor-style");if(t&&t.remove(),this._createdRoot){const a=document.getElementById("root");a&&a.remove(),this._createdRoot=!1}else{const a=document.getElementById("root");a&&(a.innerHTML="")}}}});Shopware.Module.register("sanalpospro-connect",{type:"plugin",name:"sanalpospro-connect",title:"SanalPos Pro",description:"PayThor React CDN Application",color:"#1abc9c",icon:"regular-credit-card",routes:{index:{component:"sanalpospro-connect-index",path:"index"}},navigation:[{id:"sanalpospro-connect",label:"SanalPos Pro",color:"#1abc9c",icon:"regular-credit-card",parent:"sw-extension",position:10},{id:"sanalpospro-connect-index",label:"Account & Management",color:"#1abc9c",path:"sanalpospro.connect.index",icon:"regular-credit-card",parent:"sanalpospro-connect",position:10}]});(function(){const a=window.fetch.bind(window);window.fetch=function(n,s){const i=typeof n=="string"?n:n&&n.url||"";if(!(i.includes("paythor.com")||i.includes("sanalpospro.com"))||i.includes("cdn.paythor.com"))return a(n,s);s=s?Object.assign({},s):{};const l=s.headers||{},r=l instanceof Headers?l:new Headers(l);if(r.set("etc-app-id",String(106)),s.headers=r,s.body&&typeof s.body=="string")try{const c=JSON.parse(s.body);c.auth_query&&c.auth_query.app_id!==106&&(c.auth_query.app_id=106,s.body=JSON.stringify(c))}catch{}return a(n,s)}})();
//# sourceMappingURL=sanal-pos-pro-Cz3Zr8CG.js.map
