...
<sw-page class="sanalpospro-webhook-log-list">
    ...
    `,mounted(){let e=106;try{const t=localStorage.getItem("paythor-merchant-app");t&&!isNaN(parseInt(t))&&(e=parseInt(t))}catch{}this._resolvedAppId=e,this.loadPayThorApp()},beforeDestroy(){this.cleanupPayThorApp()},methods:{async loadPayThorApp(){if(this.cleanupPayThorApp(),this._createdRoot=!document.getElementById("root"),this._createdRoot){const o=document.createElement("div");o.id="root",o.style.cssText="width: 100%; min-height: 800px; background: transparent;",this.$refs.reactContainer?this.$refs.reactContainer.appendChild(o):(o.style.cssText="position:fixed;top:130px;left:240px;right:0;bottom:0;z-index:10;background:#fff;overflow:auto;",document.body.appendChild(o))}try{const o=String(this._resolvedAppId||106),i="paythor-connect-app-id",r=["etc-token","etc-user-level","etc-is-impersonating","etc-original-admin-token","etc-impersonate-token"];localStorage.getItem(i)!==o&&(r.forEach(c=>localStorage.removeItem(c)),sessionStorage.clear(),localStorage.setItem(i,o))}catch(o){console.warn("SanalPosPro: LocalStorage access denied",o)}let e="shopware",t="/sanalpospro/iapi/index";try{const o=Shopware.Context.api.authToken&&Shopware.Context.api.authToken.access;if(o){const i=await fetch("/api/sanalpospro/admin-config",{headers:{Authorization:"Bearer "+o,Accept:"application/json"}});if(i.ok){const r=await i.json();e=r.xfvv||e,t=r.target_url||t}else console.error("SanalPosPro: Failed to fetch admin config",i.status)}else console.warn("SanalPosPro: no admin auth token available")}catch(o){console.error("SanalPosPro: Error fetching admin config",o)}const s=this._resolvedAppId||106,n=`https://cdn.paythor.com/1/${s}/10.0.4`;window.xfvv=e,window.target_url=window.location.origin+t,window.store_url=window.location.origin,window.app_id=s,window.platform="shopware",window.program_id=1,window.style_url=`${n}/index.css`,window.generalSettings={order_status:{default_value:"process",options:{process:"Processing"}},currency_convert:{default_value:"no",options:{yes:"Yes",no:"No"}},showInstallmentsTabs:{default_value:"no",options:{yes:"Yes",no:"No"}},paymentPageTheme:{default_value:"modern",options:{classic:"Classic",modern:"Modern"}}};const a=document.createElement("link");a.id="paythor-style",a.rel="stylesheet",a.href=window.style_url,document.head.appendChild(a);const l=document.createElement("script");l.id="paythor-script",l.type="module",l.src=`${n}/index.js?v=`+Date.now(),l.onerror=()=>console.error("[SanalPosPro] CDN script failed to load:",l.src),document.body.appendChild(l)},cleanupPayThorApp(){const e=document.getElementById("paythor-script");e&&e.remove();const t=document.getElementById("paythor-style");if(t&&t.remove(),this._createdRoot){const s=document.getElementById("root");s&&s.remove(),this._createdRoot=!1}else{const s=document.getElementById("root");s&&(s.innerHTML="")}}}});Shopware.Module.register("sanalpospro-connect",{type:"plugin",name:"sanalpospro-connect",title:"SanalPos Pro",description:"PayThor React CDN Application",color:"#1abc9c",icon:"regular-credit-card",routes:{index:{component:"sanalpospro-connect-index",path:"index"}},navigation:[{id:"sanalpospro-connect",label:"SanalPos Pro",color:"#1abc9c",icon:"regular-credit-card",parent:"sw-extension",position:10},{id:"sanalpospro-connect-index",label:"Account & Management",color:"#1abc9c",path:"sanalpospro.connect.index",icon:"regular-credit-card",parent:"sanalpospro-connect",position:10}]});(function(){const s=window.fetch.bind(window);window.fetch=function(n,a){const l=typeof n=="string"?n:n&&n.url||"";if(!(l.includes("paythor.com")||l.includes("sanalpospro.com"))||l.includes("cdn.paythor.com"))return s(n,a);a=a?Object.assign({},a):{};const r=a.headers||{},c=r instanceof Headers?r:new Headers(r);if(c.set("etc-app-id",String(106)),a.headers=c,a.body&&typeof a.body=="string")try{const p=JSON.parse(a.body);p.auth_query&&p.auth_query.app_id!==106&&(p.auth_query.app_id=106,a.body=JSON.stringify(p))}catch{}return s(n,a)}})();
//# sourceMappingURL=sanal-pos-pro-C3maeCq4.js.map
